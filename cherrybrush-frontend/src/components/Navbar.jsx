...
export function Navbar() {
  ...
  hover:after:w-full"
              >
                <a href="/catalog">Press On Nails</a>
              </li>
              <li
                className="px-2.5 py-2 relative
  after:content-['']
            ...
            {user ? (
              <>
                <div className="inline-flex items-center">
                  <Link
                    to="/account"
                    className="p-0.5 border rounded-full mr-2"
                  >
                    <User2 />
                  </Link>
                  <button
                    onClick={handleLogout}
                    className="font-semibold px-2.5 py-3 rounded-lg bg-red-500 text-white stroke-2"
                  >
                    <LuLogOut className="stroke-2" />
                  </button>
                </div>
              </>
            ) : (
            ...
            {user ? (
              <>
                <div>
                  <Link
                    to="/account"
                    className="flex items-center py-2.5 px-5 border-b border-white mb-4"
                  >
