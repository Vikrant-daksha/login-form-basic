...
export function Product() {
    ...
    async function submit(e) {
        ...
        try{
            ...
            const slug = product.toLowerCase().replace(/\s+/g, "-").replace(/[^\w-]+/g, "");
                ...
                <form>
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="flex">
                            ...
                            <input type="text" className="border border-gray-300 p-2 pl-3 rounded-lg" onChange = {(e)=> {setDesc(e.target.value)}} placeholder="• • • • • • • • • •" name = "price" id = "price" value={desc}></input>
                        </div>
                        <div className="flex">
                            <label className="font-semibold mb-1">
                                Enter Amount
                            </label>
                            <input type="text" className="border border-gray-300 p-2 pl-3 rounded-lg" onChange = {(e)=> {setAmount(e.target.value)}} placeholder="• • • • • • • • • •" name = "price" id = "price" value={amount}></input>
                        </div>
                        <div className="flex">
                            <label className="font-semibold mb-1">
                                Is On Sale
                            </label>
                            <input type="checkbox" checked={sale} onChange={(e) => {setSale(e.target.checked)}} className="border border-gray-300 p-2 pl-3 rounded-lg"></input>
                        </div>
                        <div onDragOver={(e)=>e.preventDefault()} onDrop={handleDrop} className="border-2 border-dashed p-10 text-center">
                            Drop images here
                        </div>
