          ...
          <div className="bg-white shadow-xl rounded-3xl overflow-hidden border border-gray-100">
            ...
            <div className="w-full bg-muted p-8 text-center sm:text-left sm:flex sm:items-center sm:justify-between">
              ...
              <button
                ...
                className="mt-6 w-full sm:w-1/4 sm:mt-0 flex items-center justify-center px-6 py-2.5 bg-secondary text-primary hover:text-secondary font-bold rounded-full hover:bg-primary transition-all delay-75 active:scale-95 shadow-lg"
              >
