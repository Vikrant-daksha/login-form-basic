      ...
      <div className="no-select-global">
        <div className="flex items-center justify-center flex-col mt-28 mb-28">
          <div className="border min-w-96 p-6 rounded-2xl">
            ...
            <div className="mb-6">
              <p className="flex items-center justify-center font-semibold text-2xl mb-1.5">
                Register
              </p>
            ...
            <form onSubmit={submit}>
              <div className="flex justify-evenly mb-7">
                <button className="px-3 sm:px-8 py-2 border border-gray-300 rounded-md text-xl">
                  <FaApple />
                </button>
                <button className="px-3 sm:px-8 py-2 border border-gray-300 rounded-md text-lg">
                  <FaGoogle />
                </button>
                <button className="px-3 sm:px-8 py-2 border border-gray-300 rounded-md text-lg">
                  <FaXTwitter />
              ...
              <div className="flex justify-center flex-col relative mb-8">
                ...
                <input
                  ...
                  value={username}
                ></input>
                <label className="font-semibold mb-1 mt-3">Password</label>
                <input
                  type={showPass ? "text" : "password"}
                  className="border border-gray-300 p-2 pl-3 rounded-lg flex items-center justify-center"
                  onChange={(e) => {
              ...
              <div className="min-w-full min-h-11">
                <button
                  className="border rounded-lg min-h-11 min-w-full bg-black text-white font-semibold"
                  onClick={submit}
                >
                  Register
                </button>
